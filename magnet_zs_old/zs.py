...
class ZeemanSlower():
    def __init__(self, data_x, data_y, dimension=(20,40,40)):
        self.objects=[]
        self.max_length=300
...
def create_zs(start_x1, stop_x1, start_r1, stop_r1, magnets_rotation1,
            start_x2, stop_x2, start_r2, stop_r2, magnets_rotation2,
            dimension=(15,30,30), number=4,sides = sides):
...
p0 = [0, 150, 50, 50, 45,  150, 300, 50, 50, 225]
...
zs.calc(plot=False, show_anim=True, extra_plots=[(0,1), (1,0), (0,2), (2,0)], direction=2)
print(zs.B)
plt.plot(zs.B, label=['Bx','By','Bz'])
plt.legend()
plt.show()
