...
min_r=25
min = [0, 50, min_r, min_r, -4, -1,
       50, 100, min_r, min_r, -4, -1]

max_r=50 #59
max = [100, 250, max_r, max_r, 4, 1,
       250, 316, max_r, max_r, 4, 1]
bounds = (min, max)
...
zs.calc(plot=True, show_anim=True, extra_plots=[(0,0), (0,0)], direction=0)
#print(zs.B)
